...
JNIEXPORT jstring JNICALL Java_com_it_1tech613_zhe_teenew_MainActivity_getOne(JNIEnv *env, jobject instance){
    return (*env)->NewStringUTF(env, "dGVlbmV3");
}
JNIEXPORT jstring JNICALL Java_com_it_1tech613_zhe_teenew_MainActivity_getTwo(JNIEnv *env, jobject instance){
    return (*env)->NewStringUTF(env, "aHR0cDovL3RoZXJhZGlvc2hhay5jby51ay9pcHR2L2luZGV4LnBocD9saWNlbmNlX2tleQ==");
}
JNIEXPORT jstring JNICALL Java_com_it_1tech613_zhe_teenew_MainActivity_getThree(JNIEnv *env, jobject instance){
...
JNIEXPORT jstring JNICALL Java_com_it_1tech613_zhe_teenew_MainActivity_getFour(JNIEnv *env, jobject instance){
